...
--CREATE LOGINS--
CREATE LOGIN admin_user WITH PASSWORD = 'Admin@001';
GO
CREATE LOGIN readonly_user WITH PASSWORD = 'Random@002';
GO
CREATE LOGIN insertupdate_user WITH PASSWORD = 'Insert@003';
GO
...
GO
 ...
 USE master;
 GO
 CREATE MASTER KEY ENCYPTION BY PASSWORD = 'Admin@001';
 GO
 ...
 BACKUP CERTIFICATE BackupCert TO FILE = 'C: \Backup\BackupCert.cer' WITH PRIVATE KEY
   (   
      ...
      ENCRYPTION BY PASSWORD = 'Admin@001S'
    );
    GO
